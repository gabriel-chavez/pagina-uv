(function ($) {
  ...
  $(window).on("load", function () {
    ...
    if ($("#main-slider-five__thumb").length) {
      let testimonialsThumb = new Swiper("#main-slider-five__thumb", {
        slidesPerView: 3,
        spaceBetween: 0,
        speed: 1400,
      ...
      let testimonialsCarousel = new Swiper("#main-slider-five__carousel", {
        observer: true,
        observeParents: true,
        loop: true,
        speed: 1400,
        ...
        navigation: {
          nextEl: "#main-slider-five__swiper-button-next",
          prevEl: "#main-slider-five__swiper-button-prev"
        }
      });
    }
